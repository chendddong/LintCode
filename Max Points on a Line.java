...
//                 double k = getK(i, j, points);
                
//                 if (hash.get(k) != null) {
//                     hash.put(k, (int)hash.get(k) + 1);
//                     break;
//                 }
...
//         // get the k with the best number
//         int best = 1;
//         Iterator it = hash.entrySet().iterator();
//         while (it.hasNext()) {
//             Map.Entry pair = (Map.Entry)it.next();
//             if ((int)pair.getValue() > best) {
                
//                 best = Math.max((int)pair.getValue(), best);
//             }
...
//     private double getK(int index_1, int index_2, Point[] points) {
//         // k = delta(y) / delta(x);
//         double k = 0;
//         k = (double)(points[index_2].y - points[index_1].y) / (double)(points[index_2].x - points[index_1].x);
//         return k;
//     }
// }
